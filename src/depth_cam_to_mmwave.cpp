...
class DepthCamToMmwave : public rclcpp::Node
{
	...
	public:
      ...
      configurator_.DeclareParameter("/tf/sim/depth_cam_frame_id", rclcpp::ParameterType::PARAMETER_STRING);
      configurator_.DeclareParameter("/tf/mmwave_frame_id", rclcpp::ParameterType::PARAMETER_STRING);
